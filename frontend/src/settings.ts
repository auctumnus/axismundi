...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const pfpInput = document.getElementById("profile_picture") as HTMLInputElement | null;

  const bannerImage = document.getElementById("banner-img-input") as HTMLImageElement | null;
  const pfpImage = document.getElementById("pfp-img-input") as HTMLImageElement | null;
  ...
  setupImagePreview(pfpInput, pfpImage);
})