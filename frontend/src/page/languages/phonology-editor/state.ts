      ...
      rows: [
        {
          type: "Individual",
          heading: "Nasal",
          cells: [cell("m"), cell("n"), cell("ŋ"), cell()],
        },
        {
          type: "Individual",
          heading: "Plosive",
          cells: [cell("p", "b"), cell("t", "d"), cell("k"), cell()],
        },
        {
          type: "Individual",
          heading: "Fricative",
          cells: [cell(), cell("s"), cell(), cell("h")],
        },
        {
          type: "Individual",
          heading: "Approximant",
          cells: [cell("w"), cell("l"), cell(), cell()],
        },
      ],
      columns: [
    ...
    "Estonian Consonants": {
      rows: [
          ...
          rows: [
            {
              type: "Individual",
              heading: "Short",
              cells: [cell("p"), cell("t"), cell("tʲ"), cell("k"), cell()],
            },
            {
              type: "Individual",
              heading: "Long",
              cells: [cell("pː"), cell("tː"), cell("tʲː"), cell("kː"), cell()],
            },
          ],
        },
        {
        ...
        },
        {
          type: "Individual",
          heading: "Approximant",
          cells: [cell("v"), cell("l"), cell("lʲ"), cell("j"), cell()],
        },
        {
          type: "Individual",
          heading: "Trill",
          cells: [cell(), cell("r"), cell(), cell(), cell()],
        },
      ],
      columns: [
        { type: "Individual", heading: "Labial" },
      ...
      rows: [
        {
          type: "Individual",
          heading: "High",
          cells: [cell("i"), cell(), cell("u")],
        },
        {
          type: "Individual",
          heading: "Mid",
          cells: [cell("e"), cell("ə"), cell("o")],
        },
        {
          type: "Individual",
          heading: "Low",
          cells: [cell(), cell("a"), cell()],
        },
      ],
      columns: [
      ...
      rows: [
        {
          ...
          heading: "Close",
          cells: [
            { phonemes: [{ text: "i", annotations: [0] }] },
            { phonemes: [{ text: "ĩ", annotations: [0] }] },
            cell(),
            cell(),
            { phonemes: [{ text: "u", annotations: [0] }] },
            { phonemes: [{ text: "ũ", annotations: [0] }] },
          ],
        },
        {
          type: "Individual",
          heading: "Close-mid",
          cells: [cell("e"), cell(), cell("ə"), cell(), cell("o"), cell()],
        },
        {
          type: "Individual",
          heading: "Open-mid",
          cells: [cell("ɛ"), cell(), cell(), cell(), cell("ɔ"), cell()],
        },
        {
          type: "Individual",
          heading: "Open",
          cells: [cell(), cell(), cell("a"), cell("ã"), cell(), cell()],
        },
      ],
      columns: [
        {
      ...
      rows: [
        {
          type: "Individual",
          heading: "Nasal",
          cells: [cell("ŋǀ"), cell("ŋǃ"), cell("ŋǁ")],
        },
        {
          type: "Individual",
          heading: "Voiced",
          cells: [cell("gǀ"), cell("gǃ"), cell("gǁ")],
        },
        {
          type: "Individual",
          heading: "Tenuis",
          cells: [cell("kǀ"), cell("kǃ"), cell("kǁ")],
        },
        {
          type: "Individual",
          heading: "Aspirated",
          cells: [cell("kǀʰ"), cell("kǃʰ"), cell("kǁʰ")],
        },
        {
          type: "Individual",
          heading: "Glottalized",
          cells: [cell("ᵑǀˀ"), cell("ᵑǃˀ"), cell("ᵑǁˀ")],
        },
      ],
      annotations: [],
    },
      ...
      rows: [
        {
          type: "Individual",
          heading: "Close",
          cells: [cell(), cell("iu̯"), cell("yu̯"), cell("ui̯"), cell()],
        },
        {
          type: "Individual",
          heading: "Mid",
          cells: [
            { phonemes: [{ text: "ɛi̯", annotations: [1, 2] }] },
            cell("eːu̯"),
            { phonemes: [{ text: "œy̯", annotations: [1] }] },
            cell("ɔi̯", "oːi̯"),
            { phonemes: [{ text: "ɔu̯", annotations: [0, 1] }] },
          ],
        },
        {
          type: "Individual",
          heading: "Open",
          cells: [cell(), cell(), cell(), cell("ɑi̯", "aːi̯"), cell()],
        },
      ],
      annotations: [
...
export type KeybindState = "Idle" | "Phoneme" | "Annotation" | "Heading";
...
export const isRowFocused = (
  ...
  if (state.focus.type === "RowHeading") {
    ...
    return isPathEqual(state.body, state.focus, {
      type: "Cell",
      rowPath,
      colPath: state.focus.colPath,
    });
  }
  return false;
};

export const isColumnFocused = (
  state: EditorState,
  colPath: HeadingPath,
): boolean => {
  if (state.focus.type === "ColumnHeading") {
    const normalized = normalizeHeadingPath(
      state.body.columns,
      state.focus.path,
    );
    if (!normalized) {
...
const removeCellsFromAllRows = (
  ...
  return rows.map((row) => {
    if (row.type === "Individual") {
      ...
      return {
        ...row,
        rows: removeCellsFromAllRows(row.rows, colIndex, count),
      };
    }
  });
};
...
const removeAnnotationFromAllRows = (
  rows: Row[],
  annotationIndex: number,
): Row[] => {
  return rows.map((row) => {
    if (row.type === "Group") {
      return {
        ...row,
        rows: removeAnnotationFromAllRows(row.rows, annotationIndex),
      };
    }
    return {
      ...row,
  ...
  const applyInner = () => {
    switch (action.type) {
      ...
      case "AddPhoneme": {
        ...
        const newCell = {
          ...cell,
          phonemes: [...cell.phonemes, { text: phoneme, annotations: [] }],
        };
      ...
      case "RemovePhoneme": {
        ...
        const newCell = {
          ...cell,
          phonemes: cell.phonemes.filter((_, i) => i !== index),
        };
        return { ...state, body: setByPath(state.body, path, newCell) };
      }
      case "EditPhoneme": {
        ...
        const newCell = {
          ...cell,
          phonemes: cell.phonemes.map((p, i) =>
      ...
      case "AddNewAnnotation": {
        ...
        if (path.type !== "Cell") {
          console.warn(
            "AddNewAnnotation action applied to non-cell path",
            path,
          );
          return state;
        }
        ...
        const newPhoneme = {
          ...cell.phonemes[phonemeIndex]!,
          annotations: [
            ...cell.phonemes[phonemeIndex]!.annotations,
            annotationIndex,
          ],
        };
        const newCell = {
      ...
      case "LinkAnnotation": {
        ...
        if (
          annotationIndex < 0 ||
          annotationIndex >= state.body.annotations.length
        ) {
          console.warn(
            "LinkAnnotation action with invalid annotation index",
            annotationIndex,
          );
          return state;
        }
      ...
      case "EditAnnotation": {
        ...
        if (
          ...
          console.warn(
            "EditAnnotation action with invalid annotation index",
            annotationIndex,
          );
          return state;
        }
        const newAnnotations = state.body.annotations.map((a, i) =>
          i === annotationIndex ? newText : a,
        );
        return {
          ...state,
          body: { ...state.body, annotations: newAnnotations },
        };
      }
      case "RemoveAnnotation": {
        ...
        if (path.type !== "Cell") {
          console.warn(
            "RemoveAnnotation action applied to non-cell path",
            path,
          );
          return state;
        }
        ...
        const newPhoneme = {
          ...cell.phonemes[phonemeIndex]!,
          annotations: cell.phonemes[phonemeIndex]!.annotations.filter(
            (i) => i !== annotationIndex,
          ),
        };
        const newCell = {
      ...
      case "DeleteAnnotationEntirely": {
        ...
        if (
          ...
          console.warn(
            "DeleteAnnotationEntirely action with invalid annotation index",
            annotationIndex,
          );
          return state;
        }
        const newAnnotations = state.body.annotations.filter(
          (_, i) => i !== annotationIndex,
        );
        const newRows = removeAnnotationFromAllRows(
          state.body.rows,
          annotationIndex,
        );
        return {
      ...
      case "LoadPreset": {
        ...
        if (!preset) {
          console.warn(
            "LoadPreset action with invalid preset name",
            action.presetName,
          );
          return state;
        }
      ...
      case "AddHeading": {
        ...
        if (kind === "row") {
          const newRow: Row = {
            ...
            heading: "New Row",
            cells: Array.from(
              { length: numLeaves(state.body.columns) },
              () => ({ phonemes: [] }),
            ),
          };
          ...
          const colHeading = getByPath(state.body, {
            type: "ColumnHeading",
            path,
          });
          ...
          const insertColIndex =
            position === "before"
              ? leafIndex
              : leafIndex + countLeaves(colHeading as Column);

          const newCol: Column = { type: "Individual", heading: "New Column" };
          const newColumns = spliceInHeadings(
            state.body.columns,
            [...parentPath, insertAt],
            0,
            newCol,
      ...
      case "DeleteHeading": {
        ...
        if (kind === "row") {
          ...
          const newColumns = collapseColumns(
      ...
      case "EditHeading": {
        ...
        return {
          ...state,
          body: setByPath(state.body, tablePath, { heading: newHeading }),
        };
      }
      case "SplitHeading": {
        const { kind, path } = action;
      ...
      case "OpenModal":
        return {
          ...state,
          pendingModal: action.modal,
          pendingPhonemeIndex: action.phonemeIndex ?? null,
        };
      ...
      case "Undo": {
        ...
        return {
          ...
          select: state.select
            ? clampSelect(previousState.body, state.select)
            : null,
      ...
      case "Redo": {
        ...
        return {
          ...
          select: state.select
            ? clampSelect(nextState.body, state.select)
            : null,
          focusInsideTable: state.focusInsideTable,
