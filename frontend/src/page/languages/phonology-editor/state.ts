...
const markRowAutogenerated = (row: Row): Row => {
  if (row.type === "Group") {
    return {
      ...row,
      autogenerated: true,
      rows: row.rows.map(markRowAutogenerated),
    };
  }
  return { ...row, autogenerated: true };
};

const markColumnAutogenerated = (column: Column): Column => {
  if (column.type === "Group") {
    return {
      ...column,
      autogenerated: true,
      columns: column.columns.map(markColumnAutogenerated),
    };
  }
  return { ...column, autogenerated: true };
};

const markBodyAutogenerated = (body: Body): Body => ({
  ...body,
  rows: body.rows.map(markRowAutogenerated),
  columns: body.columns.map(markColumnAutogenerated),
});
...
export const PRESETS: { [key: string]: Body } = (() => {
  ...
  return Object.fromEntries(
    Object.entries(raw).map(([name, body]) => [name, markBodyAutogenerated(body)]),
  );
})();
  ...
  const applyInner = () => {
    switch (action.type) {
      ...
      case "EditHeading": {
        ...
        return {
          ...state,
          body: setByPath(state.body, tablePath, {
            heading: newHeading,
            autogenerated: false,
          }),
        };
        ...
        if (kind === "row") {
          ...
          if (heading.type === "Individual") {
            ...
            newGroup = {
              ...
              autogenerated: heading.autogenerated,
              rows: [
                { ...heading, heading: "New Row", autogenerated: true },
                emptyRow,
              ],
            };
          } else {
          ...
          if (heading.type === "Individual") {
            newGroup = {
              ...
              autogenerated: heading.autogenerated,
              columns: [
                { ...heading, heading: "New Column", autogenerated: true },
                newIndividual,
              ],
            };
          } else {
