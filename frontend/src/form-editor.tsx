...
import type { CustomEditor, CustomElement, CustomText, MentionElement } from './custom-types'
...
function FormEditor({ initialValue = '', inputName, formId }: FormEditorProps) {
  ...
  React.useEffect(() => {
    ...
    const handleSubmit = () => {
      const hiddenInput = document.getElementById(`${inputName}-hidden`) as HTMLInputElement
