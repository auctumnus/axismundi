...
export const Icon = React.forwardRef(
  (
    ...
    return (
      <span {...props} ref={ref} className={`editor-icon ${className}`}>
...
export const Toolbar = React.forwardRef(
  (
    { className = "", ...props }: PropsWithChildren<BaseProps>,
    ref: Ref<HTMLDivElement>,
  ) => <Menu {...props} ref={ref} className={`editor-toolbar ${className}`} />,
);
...
export const MentionDropdown = React.forwardRef(
  (
    { className = "", ...props }: PropsWithChildren<BaseProps>,
    ref: Ref<HTMLDivElement>,
  ) => <div {...props} ref={ref} className={`mention-dropdown ${className}`} />,
);
