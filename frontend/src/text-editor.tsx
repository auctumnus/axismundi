...
const withMentions = (editor: CustomEditor): CustomEditor => {
  ...
  editor.markableVoid = (element) => {
    return (
      (element as CustomElement).type === "mention" || markableVoid(element)
    );
  };
    ...
    children: [
      {
        type: "list-item",
        children: [
          { text: "Cmd/Ctrl+B for ", bold: false },
          { text: "bold", bold: true },
        ],
      },
      {
        type: "list-item",
        children: [
          { text: "Cmd/Ctrl+I for ", bold: false },
      ...
      },
      {
        type: "list-item",
        children: [
          { text: "Cmd/Ctrl+U for ", bold: false },
